								      	...
								      	<table width="100%">
											<tr>  
												<td bgcolor="#F7FEFF" colspan="3">
											 		...
											 		<div>订单号：${ param.orderid} 
											 		<input type="hidden" name="orderid" value="${param.orderid }"/> </div>
											 		<div>支付金额：${param.totalprice }
											 		<input type="hidden" name="money" size="6" value="${param.totalprice }"/>元</div>
											 	</td>
											</tr>
											<tr><td><br/></td></tr>
											<tr>
