  ...
  <TR>
    <TD vAlign=top height=270>
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="80%" border=0>
        ...
        <TR>
          <TD>
            <P><FONT color=#000000><BR>　　服务器出现异常 ，
            		异常信息 <%=exception.getClass().getName() %>:  <%=exception.getMessage() %></FONT>! 
...
width=7></TD>
          <TD background=images/bg.gif>
            ...
            href="http://localhost:8080/estore">返回首页</A>　 　|　　 <A 
            href="javascript:history.go(-1)">返回出错页</A>　 　|　　 <A 
            href="http://localhost:8080/estore">关闭本页</A></FONT> </DIV></TD>
          <TD width=7><IMG 
