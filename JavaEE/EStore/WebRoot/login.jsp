                                ...
                                <div class="art-post-body">
									  ...
									  <div class="login_main_mid">
									    ...
									    <dl class="login_content">
									       <dt>用户名：</dt>
									       <dd><input id="nickname" name="nickname" type="text" class="login_content_input" value="${user.nickname }"/></dd>
									    </dl>
									     <dl class="login_content">
									       <dt>密码：</dt>
									       <dd>
									         <input id="password" name="password" type="password"  class="login_content_input"  value="${user.password }" />
									       </dd>
									     </dl>
									     <dl class="login_content">
									     	<dt></dt>
