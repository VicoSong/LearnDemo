			...
			<td height="847"><table width="100%" height="100%" border="0"
					...
					<tr>
						...
						<td width="75%" height="41" align="center" valign="middle"
							background="image/link.jpg" bgcolor="#FFFFFF"><span
							class="style1">第<%=request.getParameter("account")%>名
						</span></td>

					</tr>
					<tr>
						<td height="613" valign="top" bgcolor="#FFFFFF"><br> <br>
							<br>
							<table width="96%" height="120" border="1" align="center"
								...
								<tr>
									<td height="30" class="zi"><div align="center">
											<font color="#F14D83">单价：<%=form.getNowPrice()%>元
											</font>
										</div></td>
								</tr>
								<tr>
