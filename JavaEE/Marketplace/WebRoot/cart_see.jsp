	...
	<div align="center">
        ...
        %>
							<tr class="zi">
								...
								<td><div align="center"><%=form.price%>元
									</div></td>
								<td><div align="center">
										<input name="num<%=i%>" size="7" type="text"
											value="<%=form.number%>" onBlur="check(this.form)">
									</div></td>
								<td><div align="center"><%=form.number*form.price%>元
									</div></td>
							</tr>
					...
					<table width="100%" border="0" align="center" cellpadding="0"
						...
						<tr align="center" valign="middle">
							<td height="21" colspan="2" class="linkBlack"><a href="#"
								onClick="javascript:window.open('cart_checkOut.jsp','','width=1024,height=768,top=5,left=5')">去收银台结账</a>
								| <a href="cart_clear.jsp">清空购物车</a></td>
						</tr>
					</table> <%}%>
				</td>
			</tr>
