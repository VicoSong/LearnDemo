										...
										<table width="96%" height="120" border="1" align="center"
											...
											<tr>
												...
												<td height="30"><span class="zi"
													style="text-decoration: line-through; color: #910402"><%=freeGoods.getNowPrice()%>元</span></td>
											</tr>
											<tr>
												<td height="30"><div align="center" class="zi">
														<font color="#F14D83">现价</font>
													</div></td>
												<td height="30"><span class="zi"><font
														color="#F14D83"><%=freeGoods.getFreePrice()%>元</font></span></td>
											</tr>
											<tr>
											...
											<tr>
												<td height="30" colspan="2" class="linkBlack"><div
														...
														<a href="#"
															onClick="window.open('goodsAction.do?action=16&id=<%=freeGoods.getId()%>','','width=500,height=200');">查看详细内容</a>
													</div> <%}else{%>
													<div align="right" class="zi">登录后才能购买</div>
													<%}%></td>
								...
								<table width="90%" border="0" align="center" cellpadding="0"
									...
									<form action="" name="jumpform">
										<tr align="center" class="zi">
											<td width="12%" valign="bottom">共为<%=maxPage%>页
											</td>
											<td width="17%" valign="bottom">共有<%=pageNumber%>条记录
											</td>
											<td width="17%" valign="bottom">当前为第<%=number+1%>页
											</td>
											<td width="13%" valign="bottom">
												<%if((number+1)==1){%> <span class="zi">上一页</span> <%}else{%> <a
												href="goodsAction.do?action=15&mark=1&i=<%=number-1%>">上一页</a>
											</td>
											<%}%>
											<td width="12%" valign="bottom">
												<%if(maxPage<=(number+1)){%> <span class="zi">下一页</span> <%}else{%>
												<a href="goodsAction.do?action=15&mark=1&i=<%=number+1%>">下一页</a>
											</td>
											...
											<td width="22%" align="center" valign="bottom"
												class="linkBlack">转到第 <select name="jumppage"
												onchange="Jumpping()">
