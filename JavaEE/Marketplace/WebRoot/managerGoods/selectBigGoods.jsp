		...
		<tr>
            ...
            %>
					...
					<tr>
						...
						<!--判断按小类别查询商品是否有数据--> <br> <br> 暂时没有商品的信息<br> <br>
						<br>
						<br>
							<%}else{%> <%
							...
							<table width="90%" border="0" align="center" cellpadding="0"
								...
								<tr align="center" class="zi">
									...
									<td width="19%">
										...
										href="goodsAction.do?action=12&big=<%=request.getParameter("big")%>&i=<%=number-1%>">上一页</a>
									</td>
									<%}%>
									<td width="18%">
										<%if(maxPage<=(number+1)){%> 下一页 <%}else{%> <a
										href="goodsAction.do?action=12&big=<%=request.getParameter("big")%>&i=<%=number+1%>">下一页</a>
									</td>
									<%}%>
								</tr>
							</table>
