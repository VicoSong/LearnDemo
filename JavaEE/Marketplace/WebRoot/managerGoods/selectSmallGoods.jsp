	...
	<table width="755" height="150%" border="0" align="center"
		...
		<tr>
			<td height="847" bgcolor="#FFFFFF" class="linkBlack"><table
					...
					cellspacing="0">
					<tr>
						<td width="25%" height="638" rowspan="3" valign="top"
							background="image/zuocedaohangbeijing.jpg"><jsp:include
								page="../left.jsp" /></td>
						<td width="75%" height="35" align="center" valign="middle"
					...
					<tr>
						<td height="25" align="center" valign="middle" class="zi">
							...
							<table width="99%" height="21" border="1" cellpadding="0"
								bgcolor="#DAD9D9" cellspacing="0" bordercolor="#FFFFFF"
							...
							<table width="67%" border="1" align="center" cellpadding="0"
								...
								<tr>
									<td height="30" class="zi"><div align="center">
											...
											<%}else{%>
											<font color="#FF0000"> 特价：<%=bigForm.getFreePrice()%>元
											</font>
											<%}%>
										</div></td>
								</tr>
								...
								<tr>
									<td height="30" class="zi">
										<div align="center">
											...
											<a href="#"
												onClick="window.open('goodsAction.do?action=16&id=<%=bigForm.getId()%>','','width=500,height=200');">查看详细内容</a>
							...
							<table width="90%" border="0" align="center" cellpadding="0"
								...
								<tr align="center" class="zi">
									...
									<td width="19%">
										...
										href="goodsAction.do?action=13&big=<%=request.getParameter("big")%>&small=<%=request.getParameter("small")%>&i=<%=number-1%>">上一页</a>
									</td>
									<%}%>
									<td width="18%">
										<%if(maxPage<=(number+1)){%> 下一页 <%}else{%> <a
										href="goodsAction.do?action=13&big=<%=request.getParameter("big")%>&small=<%=request.getParameter("small")%>&i=<%=number+1%>">下一页</a>
									</td>
									<%}%>
								</tr>
							</table>
