			...
			<td height="847"><table width="100%" height="100%" border="0"
					...
					<tr>
						...
						<td width="75%" height="44" align="center" valign="middle"
							background="image/xinpinshangjia.jpg" bgcolor="#FFFFFF"><div
								align="left">&nbsp;</div></td>
              ...
              for(int i=0;i<now;i++)
              {
                ...
                %>
								...
								<tr>
									<td height="159" bordercolor="#666666">
										<table width="96%" height="120" border="1" align="center"
											...
											<tr>
												<td height="30"><div align="center" class="hz">
														<font color="#F14D83">单价</font>
													</div></td>
												<td height="30"><span class="zi"><font
														color="#F14D83"><%=newGoods.getNowPrice()%>元</font></span></td>
											</tr>
											<tr>
							...
							<table width="99%" border="0" cellspacing="0" cellpadding="0">
								<tr>
									<td class="linkBlack"><div align="right">
											<a href="#" class="zi" onClick="javasrcipt:history.go(-1);">返回</a>
										</div></td>
								</tr>
							</table>
