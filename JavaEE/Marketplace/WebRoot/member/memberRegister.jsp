		...
		<form name="registerForm" method="post"
			...
			<table width="298" border="1" cellspacing="0" cellpadding="0"
				...
				<tr>
					...
					<td><div align="center">
							<input type="text" name="profession" value="学生"> <span
								class="style2">*</span>
						</div></td>
				</tr>
				<tr>
			...
			<p>
				<span class="style1">*</span>：<span class="blue">代表必添项目</span> *：<span
					class="blue">代表非必添项目</span>
			</p>
			<p>
				<input type="button" name="Submit2" value="提交"
					onClick="return submit1();"> &nbsp;&nbsp; <input
					type="reset" name="Submit3" value="重置">
			</p>
			</p>
		</form>
		<p>&nbsp;</p>
