...
<table width="193" height="635" border="0" align="center"
		...
		<td width="193" height="252" valign="middle"
			...
			<form name="form" method="post" action="memberAction.do?action=1"
				...
				<table width="80%" height="90" border="0" align="center"
					...
					<tr align="center">
						<td height="27" colspan="2"><input type="submit"
							name="Submit3" value="登录"> <input name="reset"
								...
								<table width="82%" height="77%" border="0" cellpadding="0"
									...
									<tr>
										<td class="linkBlack"><div align="center">
												<a href="#"
													onClick="javascript:window.open('member/memberRegister.jsp','','width=350,height=450,top=10,left=10')">注
													&nbsp; 册</a>
											</div></td>
									</tr>
								</table>
							</div></td>
						<td><table width="82%" height="77%" border="0"
								cellpadding="0" cellspacing="0">
								<tr>
									<td class="linkBlack"><div align="center">
											<a href="#"
												onClick="javascript:window.open('member/findOne.jsp','','width=300,height=150,top=10,left=10')">找回密码
											</a>
										</div></td>
								</tr>
							</table></td>
			...
			</form> <%System.out.println(session.getAttribute("id")!=null||session.getAttribute("form")!=null);
			...
			<table width="93%" border="0" align="center" cellpadding="0"
				...
				<tr>
					<td align="center" class="linkBlack"><a
						href="javascript:quit()">安全退出</a></td>
				</tr>
			</table> <%}%>
			<p>&nbsp;</p>
		</td>
	...
	<tr>
		<td height="142" align="center" valign="top"><table width="100%"
				...
				<tr>
					<td height="111">
						<table width="84%" height="209" border="0" align="center"
							cellpadding="0" cellspacing="0">
							<tr>
								<td height="166" valign="middle"><MARQUEE direction="up"
										onmouseout="this.start()" onmouseover="this.stop()"
										scrollAmount="1" scrollDelay="1" class="linkBlack"
										behavior="scroll">
										<%
                      for(int i=0;i<afficheList.size();i++){
                        ...
                        %>
										<div align="center">
											<a href="#"
												onClick="window.open('afficheSelect.jsp?id=<%=afficheForm.getId()%>','','width=400,height=300');"><%=afficheForm.getName()%></a>
										</div>
										<br>
										<br>
										<%}%>
	...
	<tr>
		<td height="236" valign="top"><table width="100%" height="235"
								...
								<tr align="center">
									...
									<td width="44%" class="linkBlack">
										<li type="square">
											<div align="left">
												<a
													href="sell_result.jsp?id=<%=form.getId()%>&account=<%=account+1%>"><%=form.getName()%></a>
											</div>
									</td>
									<%}%>
									<td width="5%"></li>
