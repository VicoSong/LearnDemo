...
<table width="55%" height="22" border="1" cellpadding="0"
	...
	<tr>
		...
		<td align="center" class="linkBlack"
			<%if(id.equals(bigForm.getId().toString())){out.println("bgcolor='#DAD9D9'");}%>><a
			href="goodsAction.do?action=12&big=<%=bigForm.getId()%>&id=<%=bigForm.getId()%>"><%=bigForm.getBigName()%></a></td>
		<%}%>
	</tr>
</table>
