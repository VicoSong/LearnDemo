...
<body onLoad="clockon(bgclock)">
	<div id="div1"
		style="position: absolute; text-align: center; visibility: hidden; filter: revealTrans(Transition = 8, Duration = 1) revealTrans(Transition = 9, Duration = 3) revealTrans(Transition = 10, Duration = 1) revealTrans(Transition = 11, Duration = 2) revealTrans(Transition = 12, Duration = 3) revealTrans(Transition = 17, Duration = 2) revealTrans(Transition = 18, Duration = 3) revealTrans(Transition = 19, Duration = 1) revealTrans(Transition = 20, Duration = 2) revealTrans(Transition = 21, Duration = 3)">
		<img id="img1">
	</div>
	<script language="javascript">
var n=0;
					...
					<tr>
						<td width="193" height="638" rowspan="4" valign="top"
							background="image/zuocedaohangbeijing.jpg"><jsp:include
								page="left.jsp" /></td>
						<td width="562" height="10" align="center" valign="bottom"
							bgcolor="#E2E2E2">
							<div id="bgclock" class="zi"></div>
						</td>

					</tr>
					<tr>
						<td height="39" align="center" valign="middle" bgcolor="#FFFFFF"><jsp:include
								page="topThree.jsp" /></td>
					</tr>
					<tr>
						<!--td  height="89" valign="top" background="image/guanggaotiao.jpg">		</td-->
						<td height="89" valign="top"><object
								classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"
								codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0"
								width="562" height="198">
								<param name="movie" value="image/3.swf">
								<param name="quality" value="high">
								<embed src="image/3.swf" quality="high"
									pluginspage="http://www.macromedia.com/go/getflashplayer"
									type="application/x-shockwave-flash" width="607" height="198"></embed>
							</object></td>
					</tr>
					<tr>
						<td height="524" valign="top" bgcolor="#FFFFFF"><jsp:include
								page="right.jsp" /></td>
					</tr>
				</table>
			</td>
