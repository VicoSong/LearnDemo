...
<table width="97%" height="41" border="0" align="center" cellpadding="0"
	...
	<tr align="center">
		...
		<td width="117" class="linkWhite"><a
			href="goodsAction.do?action=14&mark=0">新品上架<br> NewsGoods
		</a></td>
		<td width="117" class="linkWhite"><a
			href="goodsAction.do?action=15&mark=1">特价商品<br> At a sale
		</a></td>
...
<table width="97%" height="41" border="0" align="center" cellpadding="0"
	...
	<tr align="center">
		...
		<td width="117" class="linkWhite"><a
			href="memberAction.do?action=5&id=<%=session.getAttribute("id")%>">会员修改<br>
				Member
		</a></td>
		<td width="117" class="linkWhite"><a href="#"
			onclick="this.style.behavior='url(#default#homepage)';this.sethomepage('http://www.mingrisoft.com')">设为首页<br>
				SettingFirst
		</a></td>
	</tr>
</table>
