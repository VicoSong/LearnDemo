...
<body>
	<table width="755" border="0" align="center" cellpadding="0"
		...
		<tr valign="bottom">
			<td height="112" colspan="2" background="image/banner1.jpg"><div
					align="center">
			...
			<td width="76%" height="36" bgcolor="#FFFFFF">
				<div align="center">
					<table width="99%" height="16" border="0" cellpadding="0"
						...
						<tr>
							<td bgcolor="#E6E6E6"><div align="center">
									<font color="#990000"><b>修改公告信息</b></font>
								</div></td>
						</tr>
					</table>
					<br>
					...
					<form name="form" method="post"
						action="afficheAction.do?action=5&id=<%=affiche.getId()%>"
						onSubmit="return checkEmpty(form)">
						<table width="90%" height="243" border="1" cellpadding="0"
							cellspacing="0">
							<tr class="zi">
								<td width="23%" height="30"><div align="center">公告标题</div></td>
								<td width="77%">&nbsp;<input name="name" type="text"
									size="55" value="<%=affiche.getName()%>"></td>
							</tr>
							<tr class="zi">
								<td height="208"><div align="center">公告内容</div></td>
								<td>&nbsp;&nbsp; <textarea name="content" cols="45"
										rows="13"><%=affiche.getContent()%></textarea></td>
							</tr>
						</table>
						<p>
