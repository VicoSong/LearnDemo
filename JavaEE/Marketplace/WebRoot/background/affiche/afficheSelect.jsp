...
<body>
	<table width="755" border="0" align="center" cellpadding="0"
		...
		<tr valign="bottom">
			<td height="111" colspan="2" background="image/banner1.jpg"><div
					align="center">
					...
					<table width="90%" height="16" border="0" cellpadding="0"
						...
						<tr>
							<td bgcolor="#E6E6E6"><div align="center" class="dhz">
									<font color="#990000"><b>公告信息的查询</b></font>
								</div></td>
						</tr>
					</table>
					<br>
      ...
      AfficheForm form=(AfficheForm)list.get(i);
          %>
						<tr class="zi">
							...
							<td><div align="center">
									<a href="afficheAction.do?action=4&id=<%=form.getId()%>">修改</a>&nbsp;&nbsp;<a
										href="afficheAction.do?action=6&id=<%=form.getId()%>">查询内容</a>&nbsp;&nbsp;<a
										href="javascript:deleteAffiche('<%=form.getId()%>')">删除</a>
								</div></td>
							<%}%>
						</tr>
					</table>
					...
					<table width="90%" border="0" align="center" cellpadding="0"
						...
						<tr align="center" class="zi">
							...
							<td width="19%">
								...
								href="afficheAction.do?action=0&i=<%=number-1%>">上一页</a>
							</td>
							<%}%>
							<td width="18%">
								<%if(maxPage<=(number+1)){%> 下一页 <%}else{%> <a
								href="afficheAction.do?action=0&i=<%=number+1%>">下一页</a>
							</td>
							<%}%>

							<td width="20%">
								<div align="right">
									<a href="afficheAction.do?action=1">添加公告信息</a>&nbsp;&nbsp;&nbsp;&nbsp;
								</div>
							</td>
						</tr>
					</table>
