		...
		<tr>
			...
			<td width="76%" height="36" bgcolor="#FFFFFF">
				<div align="center">
					<table width="99%" height="16" border="0" cellpadding="0"
						...
						<tr>
							<td bgcolor="#E6E6E6"><div align="center" class="dhz">
									<font color="#990000"><b>修改商品小类别信息</b></font>
								</div></td>
						</tr>
					</table>
					<br>
					...
					<form action="smallTypeAction.do?action=5&id=<%=small.getId()%>"
                          ...
                          %>
							...
							<tr class="zi">
								...
								<td width="75%">&nbsp;&nbsp;&nbsp;&nbsp;<input name="name"
									type="text" size="50" value="<%=small.getSmallName()%>"></td>
							</tr>
						</table>
						<p>
