					...
					<table width="90%" height="16" border="0" cellpadding="0"
						...
						<tr>
							<td bgcolor="#E6E6E6"><div align="center" class="dhz">
									<font color="#990000"><b>会员信息查询</b></font>
								</div></td>
						</tr>
					</table>
      ...
      MemberForm form=(MemberForm)list.get(i);
          %>
						<tr class="zi">
							...
							<td><div align="center"><%=form.getAge()%>岁
								</div></td>
					...
					<table width="90%" border="0" align="center" cellpadding="0"
						...
						<tr align="center" class="zi">
							...
							<td width="19%" class="linkBlack">
								...
								href="memberAction.do?action=2&i=<%=number-1%>">上一页</a>
							</td>
							<%}%>
							<td width="16%" class="linkBlack">
								<%if(maxPage<=(number+1)){%>下一页<%}else{%><a
								href="memberAction.do?action=2&i=<%=number+1%>">下一页</a>
							</td>
							<%}%>
						</tr>
					</table>
