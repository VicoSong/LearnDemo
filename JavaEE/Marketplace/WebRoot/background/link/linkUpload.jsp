		...
		<tr>
			...
			<td width="76%" height="36" bgcolor="#FFFFFF">
				<div align="center">
					...
					<table width="99%" height="16" border="0" cellpadding="0"
						...
						<tr>
							<td bgcolor="#E6E6E6"><div align="center">
									<font color="#990000"><b>添加网站图片</b></font>
								</div></td>
						</tr>
					</table>
					<br>
					...
					<form action="linkDealPicture.jsp" method="post"
						...
						<table width="90%" height="60" border="1" cellpadding="0"
							...
							<tr>
								<td height="30" colspan="2"><div align="center"
										class="style1">注意：只能上传“*.gif”与“*.jpg”的图片,文件不能大于100KB</div></td>
							</tr>
					...
					<table width="99%" height="16" border="0" cellpadding="0"
						...
						<tr>
							<td bgcolor="#E6E6E6"><div align="center">
									<font color="#990000"><b><%=request.getAttribute("result")%></b></font>
								</div></td>
						</tr>
					</table>
					<br>
