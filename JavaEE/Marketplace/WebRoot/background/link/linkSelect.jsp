					...
					<table width="90%" height="16" border="0" cellpadding="0"
						...
						<tr>
							<td bgcolor="#E6E6E6"><div align="center" class="dhz">
									<font color="#990000"><b>连接网站信息的查询</b></font>
								</div></td>
						</tr>
					</table>
					...
					<table width="90%" border="0" align="center" cellpadding="0"
						...
						<tr align="center" class="zi">
							...
							<td width="19%">
								...
								href="linkAction.do?action=0&i=<%=number-1%>">上一页</a>
							</td>
							<%}%>
							<td width="18%">
								<%if(maxPage<=(number+1)){%> 下一页 <%}else{%> <a
								href="linkAction.do?action=0&i=<%=number+1%>">下一页</a>
							</td>
							<%}%>

							<td width="20%">
								<div align="right">
									<a href="linkAction.do?action=1">添加网站信息</a>&nbsp;&nbsp;&nbsp;&nbsp;
								</div>
							</td>
						</tr>
					</table>
