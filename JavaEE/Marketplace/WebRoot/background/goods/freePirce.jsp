...
<body>
	<table width="755" height="100%" border="0" align="center"
		...
		<tr valign="bottom">
			<td height="116" colspan="2" background="image/banner1.jpg">
				<div align="center">
			...
			<td width="76%" height="318" bgcolor="#FFFFFF" class="linkBlack">
				<div align="center">
					<table width="99%" height="16" border="0" cellpadding="0"
						...
						<tr>
							<td bgcolor="#E6E6E6"><div align="center">
									<font color="#990000"><b>设置特价商品</b></font>
								</div></td>
						</tr>
					</table>
					<br>
					...
					<form name="form" method="post"
						action="goodsAction.do?action=11&id=<%=goodsForm.getId()%>&mark=1"
						onSubmit="return checkEmpty(form)">
						<table width="90%" height="233" border="1" cellpadding="0"
							cellspacing="0">
							<tr>
							...
							<tr>
								...
								<td>&nbsp;&nbsp;<input name="now" type="hidden"
									value="<%=goodsForm.getNowPrice()%>"><%=goodsForm.getNowPrice()%>元
								</td>
								<td>&nbsp;&nbsp;是否特价</td>
							...
							<tr>
								...
								<td>&nbsp;&nbsp;特价价格</td>
								<td>&nbsp; <input name="free" type="text" size="12">
