		...
		<tr>
			...
			<td width="76%" height="36" bgcolor="#FFFFFF" class="linkBlack">
				<div align="center">
					<table width="99%" height="16" border="0" cellpadding="0"
						...
						<tr>
							<td bgcolor="#E6E6E6"><div align="center">
									<font color="#990000"><b>查看商品的详细情况</b></font>
								</div></td>
						</tr>
					</table>
					<br>
					...
					<table width="90%" height="209" border="1" cellpadding="0"
						cellspacing="0">
						<tr class="zi">
						...
						<tr class="zi">
							...
							<td>&nbsp;&nbsp;<%=goodsForm.getNowPrice()%>元
							</td>
							<td>&nbsp;&nbsp;特价</td>
							<td>&nbsp;&nbsp;<%=goodsForm.getFreePrice()%>元
							</td>
						</tr>
						<tr class="zi">
						...
						<tr class="zi">
							...
							<td colspan="3">&nbsp;&nbsp;<input name="imageField"
								type="image" src="<%=goodsForm.getPicture()%>" width="140"
								height="94"></td>
						</tr>
					</table>
					<table width="90%" border="0" cellspacing="0" cellpadding="0">
						<tr class="zi">
							...
							<td width="65%" height="29" align="right">
								<%if(mark.equals("0")){%> <%}else{%> <a
								href="goodsAction.do?action=11&id=<%=goodsForm.getId()%>&mark=0">删除特价信息</a>
								<%}%> &nbsp;&nbsp;
							</td>

							<td width="22%" align="right">
								<%if(mark.equals("0")){%> <a
								href="goodsAction.do?action=10&id=<%=goodsForm.getId()%>">设置特价商品</a>
								<%}else{%> <a
								href="goodsAction.do?action=10&id=<%=goodsForm.getId()%>">调整特价商品</a>
								<%}%> &nbsp;&nbsp;
							</td>
