...
<body background="image/beijingtu.jpg">
	<table width="755" border="0" align="center" cellpadding="0"
		...
		<tr>
			...
			<td width="76%" height="318" bgcolor="#FFFFFF"><div
					align="center">
					...
					<br>
					<form action="goodsAction.do?action=3" method="post"
						enctype="multipart/form-data" name="form"
						onSubmit="return checkEmpty(form)">
						<table width="90%" border="1" cellspacing="0" cellpadding="0">
							<tr class="zi">
								<td width="20%" height="26">&nbsp;&nbsp;所属大类别</td>
								<td width="31%">&nbsp;&nbsp;<select name="big"
									onChange="ChangeItem()"><option value="">请选择</option>
										<%for(int i=0;i<bigList.size();i++){
            BigTypeForm bigForm=(BigTypeForm)bigList.get(i);
            %>

										<option value="<%=bigForm.getId()%>"
											<%if(bigId.equals(bigForm.getId())){out.println("selected");}%>>
								...
								<td width="31%">&nbsp;<select name="small"><option
											value="">请选择</option>
               ...
               %>
							...
							<tr class="zi">
								...
								<td>&nbsp;&nbsp;<input name="nowPirce" type="text"
									size="20"></td>
								<td>&nbsp;&nbsp;初始化特价</td>
								<td>&nbsp;<input name="freePirce" type="hidden" size="20"
									value="0">0元
								</td>
							</tr>
							<tr class="zi">
								<td height="28">&nbsp;&nbsp;商品描述</td>
								<td colspan="3">&nbsp;&nbsp;<input name="introduce"
									type="text" size="50"></td>
							</tr>
						</table>
						<p align="center">
							<input type="submit" name="Submit2" value="提交">&nbsp; <input
								type="reset" name="reset" value="清除">&nbsp; <input
