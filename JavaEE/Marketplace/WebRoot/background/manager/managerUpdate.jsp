			...
			<td width="76%" height="36" bgcolor="#FFFFFF">
				<div align="center">
					...
					<table width="99%" height="16" border="0" cellpadding="0"
						...
						<tr>
							<td bgcolor="#E6E6E6"><div align="center">
									<font color="#990000"><b>修改管理员信息</b></font>
								</div></td>
						</tr>
					</table>
					<br>
					...
					<form name="form" method="post"
						action="managerAction.do?action=6&id=<%=manager.getId()%>"
						...
						<table width="58%" border="1" cellspacing="0" cellpadding="0">
							<tr class="zi">
								...
								<td width="77%">&nbsp;<input name="account" type="hidden"
									size="35" value="<%=manager.getAccount()%>"><%=manager.getAccount()%></td>
							</tr>
							<tr class="zi">
