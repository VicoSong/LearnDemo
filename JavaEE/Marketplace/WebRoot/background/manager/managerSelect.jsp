					...
					<table width="90%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td width="20%" height="20" colspan="4"><div align="right">
									<a href="managerAction.do?action=7">修改您的密码</a><span class="zi">&nbsp;&nbsp;&nbsp;</span>
								</div></td>
						<tr>
					</table>
					<table width="90%" border="1" cellspacing="0" cellpadding="0">
						...
						<tr class="zi">
							<td width="20%" height="25"><div align="center">
									<span class="zi">数据编号</span>
								</div></td>
							<td width="20%"><div align="center">
									<span class="zi">管理员账号</span>
								</div></td>
							<td width="20%"><div align="center">
									<span class="zi">管理员姓名</span>
								</div></td>

							<%if(sigh==1){%>
							<td width="44%"><div align="center">
									<span class="zi">操作</span>
								</div></td>
							<%}else{}%>
						</tr>
          ...
          %>
						<tr class="zi">
							...
							<td><div align="center">
									...
									<span class="zi"><a
										href="managerAction.do?action=5&account=<%=form.getAccount()%>">修改</a>&nbsp;&nbsp;&nbsp;&nbsp;
										<%if(form.getSigh().intValue()==0){%> <a
										href="javascript:deleteManager('<%=form.getId()%>')">删除</a> <%}else{%>删除<%}%>
									</span>
								</div></td>
							<%}else{}%>
						</tr>
					...
					<table width="90%" border="0" align="center" cellpadding="0"
						...
						<tr align="center" class="zi">
							<td width="13%"><span class="zi">共为<%=maxPage%>页
							</span></td>
							<td width="16%"><span class="zi">共有<%=pageNumber%>条记录
							</span></td>
							<td width="14%"><span class="zi">当前为第<%=number+1%>页
							</span></td>
							<td width="19%"><span class="zi">
									<%if((number+1)==1){%> 上一页<%}else{%><a
									href="managerAction.do?action=1&i=<%=number-1%>">上一页</a>
							</span></td>
							<%}%>
							<td width="18%"><span class="zi">
									<%if(maxPage<=(number+1)){%>下一页<%}else{%><a
									href="managerAction.do?action=1&i=<%=number+1%>">下一页</a>
							</span></td>
							<%}%>
							<%if(sigh==1){%>
							<td width="20%">
								<div align="right">
									<span class="zi"><a href="managerAction.do?action=2">添加管理员</a>&nbsp;&nbsp;&nbsp;&nbsp;</span>
								</div>
							</td>
							<%}else{%>
							<%}%>
