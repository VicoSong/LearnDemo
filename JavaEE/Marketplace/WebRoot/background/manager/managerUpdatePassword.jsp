			...
			<td width="76%" height="318" bgcolor="#FFFFFF">
				<div align="center">
					<table width="99%" height="16" border="0" cellpadding="0"
						...
						<tr>
							<td bgcolor="#E6E6E6"><div align="center">
									<font color="#990000"><b>修改管理员密码</b></font>
								</div></td>
						</tr>
					</table>
					<br>
					...
					<form name="form" method="post"
						action="managerAction.do?action=8&account=<%=account%>"
						...
						<table width="60%" border="1" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td width="71%">&nbsp;<input name="old" type="password"
									size="30"></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td>&nbsp;<input name="passwordNext" type="password"
									size="30"></td>
							</tr>
						</table>
						<p>
