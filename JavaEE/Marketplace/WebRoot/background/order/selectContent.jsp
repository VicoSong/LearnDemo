		...
		<tr>
					...
					<table width="99%" height="16" border="0" cellpadding="0"
						...
						<tr>
							<td bgcolor="#E6E6E6"><div align="center" class="dhz">
									订单号为：<%=orderForm.getNumber()%>的详细信息
								</div></td>
						</tr>
					</table>
					<br>
          ...
          %>
						<tr class="zi">
							...
							<td><div align="center"><%=form.getPrice()%>元
								</div></td>
						</tr>
						<%}%>
					</table>
					<br>
					<br> <span class="zi">总金额:<%=sum%></span><br>
					<table width="76%" height="19" border="0" cellpadding="0"
						...
						<tr class="zi">
							...
							<td width="28%" class="linkBlack"><div align="right">
