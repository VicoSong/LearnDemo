...
<jsp:useBean id="orderDetail" scope="page"
	class="com.dao.OrderDetailDao" />
...
<body>
	...
	<table width="755" height="150%" border="0" align="center"
		...
		<tr>
			<td height="847" bgcolor="#FFFFFF" class="linkBlack"><table
					...
					<tr>
						...
						<td width="75%" height="33" align="center" valign="middle"
							background="image/chakandingdan.jpg">&nbsp;</td>

					</tr>

					<tr>
						<td valign="top" height="613" align="center" class="zi"><br>
							<br> <%if(orderList.size()==0){%> 没有订货信息 <%}else{%>
      ...
      for(int orderNumber=0;orderNumber<orderList.size();orderNumber++){
        ...
        %>
								<tr align="center" class="zi">
									...
									<td>
										<%if(orderForm.getSign().equals("0")){%> 否<%}else{%>是<%}%>
									</td>
									<td><a
										href="cart_detail.jsp?number=<%=orderForm.getNumber()%>">查看明细</a></td>
								</tr>

								<%}%>
							</table> <br> <%if(request.getParameter("number")!=null){%> <br>
							<span class="zi">订货明细查询</span> <br> <br>
        ...
        for(int orderDetailNumber=0;orderDetailNumber<orderDetailList.size();orderDetailNumber++){
         ...
         %>
							...
							<table width="89%" border="0" cellspacing="0" cellpadding="0">
								<tr>
									<td height="24" align="right" class="zi">总金额：<%=sum%>元
									</td>
								</tr>
								...
								<tr>
									<td>
										<div align="center">
											<input type="button" value="打印设置" id="button1" name="button1"
												onClick="setPrint();" /> <input type="button" value="打印预览"
												id="button2" name="button2" onClick="previewPrint();" /> <input
												type="button" value="打印订单明细表" id="button3" name="button3"
		...
		<tr bgcolor="#FFFFFF">
			<td height="100"><div align="center"><jsp:include
						page="downNews.jsp" /></div></td>
		</tr>
	</table>
</body>
</html>
