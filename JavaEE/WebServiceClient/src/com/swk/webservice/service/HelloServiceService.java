 ...
 * 
 */
@WebServiceClient(name = "HelloServiceService", targetNamespace = "http://service.webservice.swk.com/", wsdlLocation = "http://localhost:9090/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICESERVICE_QNAME = new QName("http://service.webservice.swk.com/", "HelloServiceService");
    ...
    public HelloService getHelloServicePort() {
        return super.getPort(new QName("http://service.webservice.swk.com/", "HelloServicePort"), HelloService.class);
    }
    ...
    public HelloService getHelloServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.webservice.swk.com/", "HelloServicePort"), HelloService.class, features);
    }
