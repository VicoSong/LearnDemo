...
create table student (
	...
	stu_birth datetime,
	nativeplace varchar(60),
	coll_id char(2) not null,
	dept_id char(4) not null,
	class_id char(6) not null,
	cometime datetime not null,
	constraint stu_fk1 foreign key(class_id) references classes(class_id),
...
create table course (
	cou_id char(6) primary key,
	cou_name varchar(30) not null,
	xuefen numeric(3,1) not null,
	coll_id char(2) not null,
	dept_id char(4) not null,
